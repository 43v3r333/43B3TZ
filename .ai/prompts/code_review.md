# 🦾 Automated PR Quality Gate Reviewer Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Automated PR Quality Gate Reviewer Prompt.
...
```markdown
# CONTEXT: You are executing a Automated PR Quality Gate Reviewer Prompt task.
