# 🦾 Database Schema Migration & Hypertable Update Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Database Schema Migration & Hypertable Update Prompt.
...
```markdown
# CONTEXT: You are executing a Database Schema Migration & Hypertable Update Prompt task.
