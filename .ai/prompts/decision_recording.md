# 🦾 ADR Architecture Formulation Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for ADR Architecture Formulation Prompt.
...
```markdown
# CONTEXT: You are executing a ADR Architecture Formulation Prompt task.
