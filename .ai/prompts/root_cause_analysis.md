...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Root Cause Postmortem Prompt.
...
```markdown
# CONTEXT: You are executing a Root Cause Postmortem Prompt task.
