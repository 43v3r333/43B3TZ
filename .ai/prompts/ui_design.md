# 🦾 Visual Theme Precision & Negative Space Alignment Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Visual Theme Precision & Negative Space Alignment Prompt.
...
```markdown
# CONTEXT: You are executing a Visual Theme Precision & Negative Space Alignment Prompt task.
