# 🦾 Legacy Script Schema Modernization Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Legacy Script Schema Modernization Prompt.
...
```markdown
# CONTEXT: You are executing a Legacy Script Schema Modernization Prompt task.
