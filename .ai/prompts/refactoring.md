# 🦾 Safe Refactoring and Clean Code Standard Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Safe Refactoring and Clean Code Standard Prompt.
...
```markdown
# CONTEXT: You are executing a Safe Refactoring and Clean Code Standard Prompt task.
