# 🦾 RESTful Contract & Version Routing Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for RESTful Contract & Version Routing Prompt.
...
```markdown
# CONTEXT: You are executing a RESTful Contract & Version Routing Prompt task.
