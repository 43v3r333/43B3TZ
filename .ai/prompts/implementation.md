# 🦾 Surgical Feature Implementation Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Surgical Feature Implementation Prompt.
...
```markdown
# CONTEXT: You are executing a Surgical Feature Implementation Prompt task.
