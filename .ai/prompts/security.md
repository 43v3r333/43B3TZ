# 🦾 Threat Modeling & Security Review Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Threat Modeling & Security Review Prompt.
...
```markdown
# CONTEXT: You are executing a Threat Modeling & Security Review Prompt task.
