# 🦾 Responsive React 19 UI Component Development Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Responsive React 19 UI Component Development Prompt.
...
```markdown
# CONTEXT: You are executing a Responsive React 19 UI Component Development Prompt task.
