# 🦾 Comprehensive Unit and Integration Testing Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Comprehensive Unit and Integration Testing Prompt.
...
```markdown
# CONTEXT: You are executing a Comprehensive Unit and Integration Testing Prompt task.
