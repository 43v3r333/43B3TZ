# 🦾 Semantic Context Parsing Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Semantic Context Parsing Prompt.
...
```markdown
# CONTEXT: You are executing a Semantic Context Parsing Prompt task.
