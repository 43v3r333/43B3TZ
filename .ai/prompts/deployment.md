# 🦾 Dockerized Cloud Run Deploy Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Dockerized Cloud Run Deploy Prompt.
...
```markdown
# CONTEXT: You are executing a Dockerized Cloud Run Deploy Prompt task.
