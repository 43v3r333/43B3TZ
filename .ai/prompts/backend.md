# 🦾 High-Throughput Asynchronous FastAPI Endpoint Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for High-Throughput Asynchronous FastAPI Endpoint Prompt.
...
```markdown
# CONTEXT: You are executing a High-Throughput Asynchronous FastAPI Endpoint Prompt task.
