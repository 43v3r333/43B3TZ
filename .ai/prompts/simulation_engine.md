# 🦾 Monte Carlo League Performance Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Monte Carlo League Performance Prompt.
...
```markdown
# CONTEXT: You are executing a Monte Carlo League Performance Prompt task.
