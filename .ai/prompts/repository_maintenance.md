# 🦾 Clean Workspace Dependency Check Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Clean Workspace Dependency Check Prompt.
...
```markdown
# CONTEXT: You are executing a Clean Workspace Dependency Check Prompt task.
