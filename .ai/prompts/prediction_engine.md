# 🦾 Outcome Probability Inference Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Outcome Probability Inference Prompt.
...
```markdown
# CONTEXT: You are executing a Outcome Probability Inference Prompt task.
