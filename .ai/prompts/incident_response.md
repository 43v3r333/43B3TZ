# 🦾 High Severity Incident Response Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for High Severity Incident Response Prompt.
...
```markdown
# CONTEXT: You are executing a High Severity Incident Response Prompt task.
