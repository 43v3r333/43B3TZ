# 🦾 WAI-ARIA Color Contrast & Layout Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for WAI-ARIA Color Contrast & Layout Prompt.
...
```markdown
# CONTEXT: You are executing a WAI-ARIA Color Contrast & Layout Prompt task.
