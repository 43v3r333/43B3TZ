# 🦾 Performance Optimization and Benchmarking Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Performance Optimization and Benchmarking Prompt.
...
```markdown
# CONTEXT: You are executing a Performance Optimization and Benchmarking Prompt task.
