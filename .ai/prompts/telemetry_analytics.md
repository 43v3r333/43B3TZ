# 🦾 Grafana SLA Alert Logic Formulation Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Grafana SLA Alert Logic Formulation Prompt.
...
```markdown
# CONTEXT: You are executing a Grafana SLA Alert Logic Formulation Prompt task.
