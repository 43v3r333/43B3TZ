# 🦾 Deterministic Bug Investigation and Patching Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Deterministic Bug Investigation and Patching Prompt.
...
```markdown
# CONTEXT: You are executing a Deterministic Bug Investigation and Patching Prompt task.
