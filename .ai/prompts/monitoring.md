# 🦾 Prometheus & Prometheus SLA Logging Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Prometheus & Prometheus SLA Logging Prompt.
...
```markdown
# CONTEXT: You are executing a Prometheus & Prometheus SLA Logging Prompt task.
