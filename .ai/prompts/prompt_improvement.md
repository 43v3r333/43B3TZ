# 🦾 Self-Optimizing Prompt Tuning Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Self-Optimizing Prompt Tuning Prompt.
...
```markdown
# CONTEXT: You are executing a Self-Optimizing Prompt Tuning Prompt task.
