# 🦾 Fractional Kelly Criterion Capital Allocator Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Fractional Kelly Criterion Capital Allocator Prompt.
...
```markdown
# CONTEXT: You are executing a Fractional Kelly Criterion Capital Allocator Prompt task.
