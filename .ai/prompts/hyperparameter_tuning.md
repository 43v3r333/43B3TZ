...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Optuna Search Tuning Prompt.
...
```markdown
# CONTEXT: You are executing a Optuna Search Tuning Prompt task.
