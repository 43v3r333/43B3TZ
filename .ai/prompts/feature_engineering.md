# 🦾 Rolling Team Metrics Formulation Prompt
...
## 🎯 1. Purpose
Provides a reusable, deterministic prompt template to trigger optimized, zero-leak AI assistant executions for Rolling Team Metrics Formulation Prompt.
...
```markdown
# CONTEXT: You are executing a Rolling Team Metrics Formulation Prompt task.
